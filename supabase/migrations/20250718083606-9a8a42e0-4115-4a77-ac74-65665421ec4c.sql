...
-- Add unique constraint to the original characteristics table and add flat characteristics
ALTER TABLE public.characteristics ADD CONSTRAINT characteristics_name_unique UNIQUE (name);

-- Add some sample flat characteristics to the original table
